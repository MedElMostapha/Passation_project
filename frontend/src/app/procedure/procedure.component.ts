...
export class ProcedureComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private procedurePaaService: ProcedurePaaService, private http: HttpClient,private dossierService:DirectoryService) {}
  ...
  rowSelected(args: RowSelectEventArgs): void {
    ...
    this.createdDossier=this.selectedProcedure[0]['createdDossier'];
  ...
  createDossier() {
    ...
    let data = {
      "paa":{"id":this.selectedProcedure[0]["paa"]['id']},
      "procedure":{"id":this.selectedProcedure[0]['id']}
    }
